...
To finalize the set-up for publishing to PyPI or Artifactory, see [here](https://prehistoic.github.io/yt2navidrome/features/publishing/#set-up-for-pypi).
For activating the automatic documentation with MkDocs, see [here](https://prehistoic.github.io/yt2navidrome/features/mkdocs/#enabling-the-documentation-on-github).
To enable the code coverage reports, see [here](https://prehistoic.github.io/yt2navidrome/features/codecov/).
